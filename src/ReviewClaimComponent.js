...
const ReviewClaimComponent = ({ handleSendRequest, message }) => {
  ...
  // console.log(payload.fields.form.structValue.fields);
      ...
      <div>
        ...
        <table className={classes.BotMessage}>
          ...
          <tr>
            ...
            <td>{fetchValueFromField({ fields: fields, key: 'wdays' })} Days</td>
          </tr>
          <tr>
            <td>Claim Period: </td>
            <td>
              {fetchValueFromField({ fields: fields, key: 'cpstart' })} - {fetchValueFromField({ fields: fields, key: 'cpend' })}
            </td>
          </tr>
          <tr>
            <td>No. of Actual Working Days: </td>
            <td>{fetchValueFromField({ fields: fields, key: 'awdays' })} Days</td>
          </tr>
          <tr>
      ...
      <div>
        ...
        <table className={classes.BotMessage}>
          ...
          <tr>
            ...
            <td>S$ {fetchValueFromField({ fields: fields, key: 'incompay' })}</td>
          </tr>
          <tr>
